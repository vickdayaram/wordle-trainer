var app = (function () {
    ...
    const computeNextColor = (charValue, gameWord, charIdx) => {
    ...
    const updateGuessRowCharState = (guessStore, currentGuess, gameWord, charIdx) => {
        guessStore.update(storeState => {
            ...
            nextState[currentGuess][charIdx] = Object.assign(Object.assign({}, charBox), { backgroundColor, color: WHITE });
            return nextState;
        });
    };
    const sleep = (ms) => {
    ...
    const validateGuess = async (guessStore, positionStore, gameWordStore, keyboardColorStore) => {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			div2 = element("div");
    			attr_dev(div0, "class", "left-menu svelte-ffczq5");
    			add_location(div0, file$7, 12, 4, 483);
    			attr_dev(div1, "class", "app-name svelte-ffczq5");
    			add_location(div1, file$7, 15, 3, 576);
    			add_location(div2, file$7, 18, 3, 632);
    			attr_dev(div3, "class", "nav svelte-ffczq5");
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*value*/ ctx[0]);
    			attr_dev(div, "class", "char-input svelte-14b69ij");
    			add_location(div, file$5, 43, 4, 1050);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*value*/ ctx[0]);
    			attr_dev(div, "class", "char-input char-border svelte-14b69ij");
    			add_location(div, file$5, 39, 4, 951);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    		...
    		i: function intro(local) {
    			if (!div_intro) {
    				add_render_callback(() => {
    					div_intro = create_in_transition(div, /*enterCharTransition*/ ctx[2], {});
    					div_intro.start();
    				});
    			}
    		},
    ...
    // (31:0) {#if value !== "" && backgroundColor !== WHITE}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*value*/ ctx[0]);
    			attr_dev(div, "class", "char-input char-border svelte-14b69ij");
    			toggle_class(div, "green", /*backgroundColor*/ ctx[1] === GREEN);
    			toggle_class(div, "gray", /*backgroundColor*/ ctx[1] === GRAY);
    			toggle_class(div, "yellow", /*backgroundColor*/ ctx[1] === YELLOW);
    			add_location(div, file$5, 31, 4, 706);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*backgroundColor, GREEN*/ 2) {
    				toggle_class(div, "green", /*backgroundColor*/ ctx[1] === GREEN);
    			}

    			if (dirty & /*backgroundColor, GRAY*/ 2) {
    				toggle_class(div, "gray", /*backgroundColor*/ ctx[1] === GRAY);
    			}

    			if (dirty & /*backgroundColor, YELLOW*/ 2) {
    				toggle_class(div, "yellow", /*backgroundColor*/ ctx[1] === YELLOW);
    			}
    		},
    		i: noop,
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(31:0) {#if value !== \\\"\\\" && backgroundColor !== WHITE}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*value*/ ctx[0] !== "" && /*backgroundColor*/ ctx[1] !== WHITE) return create_if_block;
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['value', 'backgroundColor'];
    	...
    	return [value, backgroundColor, enterCharTransition];
    }

    class CharInput extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { value: 0, backgroundColor: 1 });
    		...
    		if (/*value*/ ctx[0] === undefined && !('value' in props)) {
    			console.warn("<CharInput> was created without expected prop 'value'");
    		}

    		if (/*backgroundColor*/ ctx[1] === undefined && !('backgroundColor' in props)) {
    			console.warn("<CharInput> was created without expected prop 'backgroundColor'");
    		}
    	}
    ...
    function create_each_block_1$1(ctx) {
    	...
    	charinput = new CharInput({
    			props: {
    				value: /*cgb*/ ctx[6].value,
    				backgroundColor: /*cgb*/ ctx[6].backgroundColor
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*board*/ 1) charinput_changes.value = /*cgb*/ ctx[6].value;
    			if (dirty & /*board*/ 1) charinput_changes.backgroundColor = /*cgb*/ ctx[6].backgroundColor;
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "key svelte-tzchwc");
    			toggle_class(button, "green", /*backgroundColor*/ ctx[2] === GREEN);
    			toggle_class(button, "gray", /*backgroundColor*/ ctx[2] === GRAY);
    			toggle_class(button, "yellow", /*backgroundColor*/ ctx[2] === YELLOW);
    			add_location(button, file$3, 26, 0, 730);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			button.innerHTML = /*keyValue*/ ctx[0];
    			/*button_binding*/ ctx[7](button);

    			if (!mounted) {
    				dispose = [
    					listen_dev(button, "click", /*handleClick*/ ctx[4], false, false, false),
    					listen_dev(button, "mouseup", /*handleMouseUp*/ ctx[5], false, false, false),
    					listen_dev(button, "mousedown", /*handleMouseDown*/ ctx[3], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*keyValue*/ 1) button.innerHTML = /*keyValue*/ ctx[0];
    			if (dirty & /*backgroundColor, GREEN*/ 4) {
    				toggle_class(button, "green", /*backgroundColor*/ ctx[2] === GREEN);
    			}

    			if (dirty & /*backgroundColor, GRAY*/ 4) {
    				toggle_class(button, "gray", /*backgroundColor*/ ctx[2] === GRAY);
    			}

    			if (dirty & /*backgroundColor, YELLOW*/ 4) {
    				toggle_class(button, "yellow", /*backgroundColor*/ ctx[2] === YELLOW);
    			}
    		},
    		i: noop,
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const unsub = keyboardColorStore.subscribe(colors => {
    		$$invalidate(2, backgroundColor = colors[keyValue] ? colors[keyValue] : "");
    	});
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('onKeyPress' in $$props) $$invalidate(6, onKeyPress = $$props.onKeyPress);
    	};
    ...
    class Key extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { keyValue: 0, onKeyPress: 6 });
    		...
    		if (/*onKeyPress*/ ctx[6] === undefined && !('onKeyPress' in props)) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "row svelte-kh57gc");
    			toggle_class(div, "center", /*rowIdx*/ ctx[10] === 1);
    			add_location(div, file$2, 50, 8, 2095);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(50:4) {#each keys as row, rowIdx}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "keyboard svelte-kh57gc");
    			add_location(div, file$2, 48, 0, 2032);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const onKeyPress = async keyValue => {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "app-container svelte-15msri0");
    			add_location(div, file, 33, 1, 1190);
    			attr_dev(main, "class", "svelte-15msri0");
    			add_location(main, file, 31, 0, 1174);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
