var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 20, 0, 668);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const unsub = keyboardColorStore.subscribe(colors => {
    		$$invalidate(1, backgroundColor = colors[keyValue]
    		? colors[keyValue]
    		: defaultBackgroundColor);

    		$$invalidate(2, color = backgroundColor === defaultBackgroundColor
    		? BLACK
    		: WHITE);
    	});
    	...
    	return [keyValue, backgroundColor, color, handleClick, onKeyPress];
    }

    class Key extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { keyValue: 0, onKeyPress: 4 });
    		...
    		if (/*onKeyPress*/ ctx[4] === undefined && !('onKeyPress' in props)) {
