...
var app = (function () {
    ...
    const reset = async (guessStore, positionStore, gameWordStore) => {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$7, 12, 4, 443);
    			attr_dev(div1, "class", "app-name svelte-u5kl6e");
    			add_location(div1, file$7, 15, 3, 536);
    			add_location(div2, file$7, 18, 3, 592);
    			attr_dev(div3, "class", "nav svelte-u5kl6e");
    			add_location(div3, file$7, 11, 0, 421);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	const { guessStore, positionStore, gameWordStore } = getContext(appContextKey);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "key svelte-78lb1m");
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 45, 8, 1778);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 43, 0, 1723);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const { guessStore, positionStore, notificationStore, gameWordStore, keyboardColorStore } = getContext(appContextKey);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 27, 1, 882);
    			attr_dev(main, "class", "svelte-16bfy2u");
    			add_location(main, file, 25, 0, 866);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
